...
import IEntityRepository from '@/services/repository/repository.service';
...
export let DB: IEntityRepository;
	...
	case 'PROD':
		{
			...
			CDN = new AWSS3CDNService(process.env.ENV === 'DEV' ? 'dev-aapc-media' : 'aapc-media');
		}
		break;
	default: {
