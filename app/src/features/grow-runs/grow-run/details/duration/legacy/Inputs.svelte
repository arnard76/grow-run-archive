<script lang="ts">
	...
	let startLocalDateInput = formatToLocalDate(startDateInput),
		endLocalDateInput = formatToLocalDate(endDateInput);

	$: startDateInput = formatToUTCISO(startLocalDateInput);
	$: endDateInput = formatToUTCISO(endLocalDateInput);
</script>
